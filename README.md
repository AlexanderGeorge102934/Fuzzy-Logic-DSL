...
## Overview
Scala project that explores domain specific languages with fuzzy logic operations. This project has a main implementation in Scala and accompanying tests.
